...
public class NotificationService(IHubContext<NotificationService> hubContext, IPermissionService permissionService)
    : Hub, INotificationService
{
    ...
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadSeries, NotificationType.SerieCreated,
            serie);
    }

    public void NotifySerieUpdatedAsync(SerieDto serie)
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadSeries, NotificationType.SerieUpdated,
            serie);
    }

    public void NotifySerieDeletedAsync(long serieId)
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadSeries, NotificationType.SerieDeleted,
            serieId);
    }

    public void NotifyRankCreatedAsync(RankDto rank)
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadRanks, NotificationType.RankCreated,
            rank);
    }

    public void NotifyRankUpdatedAsync(RankDto rank)
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadRanks, NotificationType.RankUpdated,
            rank);
    }

    public void NotifyRankDeletedAsync(long rankId)
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadRanks, NotificationType.RankDeleted,
            rankId);
    }
    ...
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadServerStats,
    ...
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadAllIssues,
            NotificationType.ReportedChapterIssueDeleted, issueId);
    }

    public void NotifySerieIssueDeletedAsync(long issueId)
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadAllIssues,
            NotificationType.ReportedSerieIssueDeleted, issueId);
    }

    public void NotifyTagCreatedAsync(TagDto tag)
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadTags, NotificationType.TagCreated,
            tag);
    }

    public void NotifyTagUpdatedAsync(TagDto tag)
    {
        TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission.ReadTags, NotificationType.TagUpdated,
            tag);
    }
    ...
    private void TrySendToClientsWithPermissionAsync(ManaxLibrary.DTO.User.Permission permission, NotificationType type,
        object? arg)
    {
